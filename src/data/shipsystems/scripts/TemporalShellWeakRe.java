...
public class TemporalShellWeakRe extends BaseShipSystemScript {
    ...
    public void apply(MutableShipStatsAPI stats, String id, ShipSystemStatsScript.State state, float effectLevel) {
        ...
        if (stats.getEntity() instanceof ShipAPI) {
            ...
            stats.getAcceleration().modifyFlat(id, 75.0F * effectLevel);
            stats.getAcceleration().modifyPercent(id, 75.0F * effectLevel);
            stats.getDeceleration().modifyPercent(id, 50.0F * effectLevel);
            stats.getTurnAcceleration().modifyFlat(id, 25.0F * effectLevel);
    ...
    public ShipSystemStatsScript.StatusData getStatusData(int index, ShipSystemStatsScript.State state, float effectLevel) {
        ...
        if (index == 0) {
            ...
            return new ShipSystemStatsScript.StatusData("Maximum speed increased", false);
        } else {
            return index == 2 ? new ShipSystemStatsScript.StatusData("Maneuverability increased", false) : null;
        }
    }
}
